        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="mt-10 grid grid-cols-2 gap-4 sm:grid-cols-4">
            <div className="flex flex-col items-center">
              ...
              <span className="text-sm font-medium text-gray-700">{t('features.unified')}</span>
            </div>
            <div className="flex flex-col items-center">
              <Globe className="h-8 w-8 text-red-600 mb-2" />
              <span className="text-sm font-medium text-gray-700">{t('features.accessible')}</span>
            </div>
            <div className="flex flex-col items-center">
              <Zap className="h-8 w-8 text-red-600 mb-2" />
              <span className="text-sm font-medium text-gray-700">{t('features.realtime')}</span>
            </div>
            <div className="flex flex-col items-center">
              <Shield className="h-8 w-8 text-red-600 mb-2" />
              <span className="text-sm font-medium text-gray-700">{t('features.reliable')}</span>
            </div>
          </div>
          ...
          <div className="mt-16 grid grid-cols-1 gap-4 sm:grid-cols-3">
            ...
            <div className="bg-white/60 backdrop-blur rounded-lg p-6 border border-red-100">
              ...
              <div className="text-sm text-gray-600">{t('stats.ministries')}</div>
            </div>
            <div className="bg-white/60 backdrop-blur rounded-lg p-6 border border-red-100">
